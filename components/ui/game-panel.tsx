...
const PANEL_CLASS =
    'relative rounded-panel border-[2.5px] border-border-action bg-surface-cream text-ink shadow-raise-panel'
...
export function GamePanel({
    ...
    const classes = [PANEL_CLASS, dashedFrame ? DASHED_FRAME_CLASS : null, className]
        .filter(Boolean)
        .join(' ')
