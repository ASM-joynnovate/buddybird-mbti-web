...
const DetailPopup = dynamic(() => import('@/features/deck/detail-popup').then((mod) => mod.DetailPopup), {
	ssr: false,
});
		...
		>
			...
			>
				...
				<m.div className="flex w-full flex-col items-center gap-4" variants={entrance}>
					...
					>
						...
						<span className="whitespace-nowrap">
							<span
								className="relative whitespace-nowrap text-primary-active after:absolute
									after:-right-[4%] after:bottom-[4%] after:-left-[4%] after:-z-10 after:h-2/5
									after:-rotate-2 after:rounded-full
				...
				<m.div className="mt-auto flex w-full flex-col items-center gap-4 pt-4" variants={entrance}>
					<GameButton variant="secondary" data-testid="deck-button" onClick={deck.openAnimated}>
						🗂 16유형 모두 보기
					</GameButton>
					...
					<div className="relative isolate flex w-full justify-center">
						...
						<GameButton data-testid="start-button" onClick={handleStart} className="w-full max-w-85">
