...
import { drawCharWindow, drawPetWindow, drawStamp, drawTape, paintPaper } from './card-parts';
...
export async function composeCard(input: ComposeCardInput): Promise<Blob> {
	...
	const captionH =
		CAP_TOP_PAD + CAP_CODE_SIZE + 12 + CAP_NAME_SIZE + 22 + taglineLines.length * CAP_TAG_LINE + CAP_BOTTOM_PAD;
