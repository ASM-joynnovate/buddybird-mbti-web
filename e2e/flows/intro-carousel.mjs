...
export async function run() {
	...
	assert(evalJs('!!document.querySelector(\'[data-testid="back-stack"]\')') === true, 'back-stack must be present');
	...
	assert(advanced !== first, `back-stack auto-advance must move the active type (stuck on ${first})`);
	...
	await waitFor(`!document.querySelector('[data-testid="detail-popup-${tapped}"]')`, 'detail popup closes');
