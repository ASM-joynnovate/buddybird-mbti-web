...
const DECAL_IMG_CLASS = 'block h-auto w-full select-none drop-shadow-[0_6px_12px_rgba(46,36,20,0.16)]';
				...
				return (
					...
					>
						<m.div className={d.motionClassName} variants={variants} initial={d.initial} animate={animate}>
							<Image className={DECAL_IMG_CLASS} src={d.src} alt="" quality={50} sizes={d.sizes} />
						</m.div>
					</div>
				);
			})}
